  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="flex flex-col md:w-3/6 justify-center items-center gap-8 p-8 md:p-12 lg:p-24 relative">
        <button type="button" className="absolute left-2 top-2 md:left-6 lg:left-12 md:top-6">
        ...
        <div className="w-full flex flex-col justify-center items-center gap-2 mt-8 md:mt-0 ">
          <p className="text-xl md:text-3xl font-semibold">Enter Your OTP</p>
          <p className="text-md md:text-lg font-normal text-[#666]">
