    ...
    <div className="w-full lg:h-full flex flex-col lg:flex-row justify-start items-center p-6 md:p-12 lg:p-0 gap-4 md:gap-12 lg:gap-0 ">
      <div className="w-3/6 md:max-w-1/6 lg:h-full">
        <img
          src={aboutfounderimg}
          alt="aboutfounderimg"
          className="w-full md:max-w-3/6 lg:h-full "
        />
      </div>

      <div className="lg:w-3/6 h-full flex flex-col justify-around items-center p-4 text-xl gap-6 text-center md:text-justify  text-[#FFA12B]">
