    ...
    return(
        <div className="bg-[#FFF0E3] p-8 md:p-12 flex flex-col justify-center items-center gap-6">
            ...
            <div className="flex flex-col md:gap-2 justify-center items-center">
                ...
                <p className="text-xl md:text-3xl text-[#6EC1E4] font-semibold ">Upcoming Events and Workshops</p>
            </div>
            ...
            <div className="flex w-full lg:w-5/6 flex-col justify-center items-center gap-4">
                {EventsData.map((item, idx) => {
                    return(
                        <motion.div key={idx} whileHover={{ scale: 1.02 }}
                         className="w-full h-full flex flex-col md:flex-row gap-4 md:gap-0 bg-white justify-center items-center rounded-xl p-4">
                            ...
                            <motion.img whileHover={{scale: 1.05}} src={item.img} alt="img" className="w-full rounded-xl max-h-1/6 object-cover object-center" />
                            ...
                            <div className="flex gap-2 w-full md:gap-4">
                             <img src={calender} alt="calender" className="w-4 md:w-6 object-cover object-center" />
                  ...
                  whileTap={{ scale: 0.95 }} className="bg-[#61CE70] w-full md:w-4/6 lg:w-3/6 rounded-full p-2 px-4">join us</motion.button>
            ...
            <div>
                <motion.button whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }} className="bg-[#44233B] rounded-full w-full text-white p-3 px-6">More Events</motion.button>
            </div>
